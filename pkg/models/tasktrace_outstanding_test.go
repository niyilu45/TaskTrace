...
func TestTaskTraceOutstandingMove(t *testing.T) {
	t.Run("reorder then move without losing neighboring items", func(t *testing.T) {
		...
		sourceID := taskTraceSeedList(t, 1, taskTraceOutstandingItem{"a", "<b>A</b>", ` data-done="true" data-priority="2" data-completed-at="2026-09-18T08:00:00.000Z" data-reminder="2026-09-21T09:30:00.000Z"`}, taskTraceOutstandingItem{"b", "B", ""}, taskTraceOutstandingItem{"c", "C", ""})
		...
		assert.Equal(t, ` data-done="true" data-priority="2" data-completed-at="2026-09-18T08:00:00.000Z" data-reminder="2026-09-21T09:30:00.000Z"`, target.items[0].metadata)
